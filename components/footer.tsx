  ...
  return (
    <footer className="footer" id="lien-he">
      ...
      <div className="container footer-grid">
        <div className="footer-brand"><Logo logoUrl={settings.logoUrl}/><p>{settings.heroDescription || "S HOUSE — giải pháp thiết bị điện được trình bày rõ ràng và dễ tiếp cận."}</p><span className="footer-brand-line">Giải pháp thiết bị điện</span></div>
        <nav className="footer-nav" aria-label="Điều hướng chân trang"><h3>Điều hướng</h3><Link href="/"><span>Trang chủ</span><ArrowUpRight/></Link><Link href="/san-pham"><span>Sản phẩm</span><ArrowUpRight/></Link><Link href="/#gioi-thieu"><span>Chính sách bảo hành</span><ArrowUpRight/></Link><Link href="/admin/login"><span>Quản trị</span><ArrowUpRight/></Link></nav>
